...
public class ExcelUtil {
	...
	public static void generateExcelFile(SXSSFWorkbook wb, String fileName, HttpServletResponse response) throws Exception {
		boolean resultType = true;
	...
	// sheet 생성 및 메인 타이틀 생성
	public static SXSSFSheet createSheetWithTitleRow(SXSSFWorkbook wb, String sheetName, int colSize) {
		sheetName = sheetName.replaceAll("_", " ");
