...
public class ItemView_ExcelUtil {
	...
	public static XSSFSheet createMainTable(XSSFSheet sheet, List<?> resultList, SearchVO vo) {
		...
		for(String str : vo.getExTit().split("\\|\\|\\|")) {
			...
			for(String headerOptions : header) {
				System.out.println("headerOptions"+headerOptions);
				System.out.println("header"+header);
				String[] valueAndOption = headerOptions.split("\\|");
				System.out.println("valueAndOption"+valueAndOption);
				...
				int mergeCnt = 0;
		       System.out.println(valueAndOption[1]);
				if(!"null".equals(valueAndOption[1])) {
					System.out.println(Integer.parseInt(valueAndOption[1]));
